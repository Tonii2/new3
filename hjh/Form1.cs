...
namespace hjh
{
    ...
    {
        private static string connectionString = @"Data Source =LAPTOP-RHMTR2G9\SQLEXPRESS;Initial Catalog=lk;Integrated Security=True;TrustServerCertificate=True";
        public Form1()
        {
            InitializeComponent();
        }
        ...
        private void RegisterUser(string nombre, string correo, string usuario, string contraseña)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                using (SqlCommand command = new SqlCommand("INSERT INTO Usuarios (Nombre, Correo, Usuario, Contraseña) VALUES (@Nombre, @Correo, @Usuario, @Contraseña)", connection))
                {
                    ...
                    if (string.IsNullOrWhiteSpace(nombre) || string.IsNullOrWhiteSpace(correo) || string.IsNullOrWhiteSpace(usuario) || string.IsNullOrWhiteSpace(contraseña))
                    {
